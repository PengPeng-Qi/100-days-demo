...
const draw = {
  hidden: (i: number) => {
    ...
    return {
      ...
      opacity: 0,
      transition: {
        pathLength: { delay, type: "tween", duration: 0.5, bounce: 0 },
...
const MyLogo = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(cycleAnimation, 12000); // 每 12 秒循环一次动画

    return () => clearInterval(interval); // 清除定时器
  }, []);

  return (
    <div className="mt-32 flex h-96 w-96 items-center justify-center border-2">
